...
/**
 * No-op sink. The upstream site pushed these into Microsoft Clarity; a static
 * GitHub Pages build ships without an analytics vendor, so events are validated
 * (in development) and dropped. Wire a provider in here to start collecting.
 */
